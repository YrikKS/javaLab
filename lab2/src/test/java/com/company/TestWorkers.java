...
public class TestWorkers {
    @Test
    public void pop() throws StackExceptions, WorkerExeption {
    ...
    @Test
    public void push() throws StackExceptions, WorkerExeption {
        StackParameters stackParameters1 = new StackParameters();
        Push push = new Push();
        ...
        WorkerExeption thrown1 = Assertions.assertThrows(WorkerExeption.class, () -> {
            StackParameters stackParameters2 = new StackParameters();
            Push push2 = new Push();
        ...
        WorkerExeption thrown2 = Assertions.assertThrows(WorkerExeption.class, () -> {
    ...
    @Test
    public void define() throws StackExceptions, WorkerExeption {
        ...
        WorkerExeption thrown3 = Assertions.assertThrows(WorkerExeption.class, () -> {
            StackParameters stackParameters3 = new StackParameters();
        ...
        WorkerExeption thrown4 = Assertions.assertThrows(WorkerExeption.class, () -> {
    ...
    @Test
    public void sum() throws StackExceptions, WorkerExeption {
        StackParameters stackParameters = new StackParameters();
    ...
    @Test
    public void minus() throws StackExceptions, WorkerExeption {
        StackParameters stackParameters = new StackParameters();
        stackParameters.stack.push("5");
        stackParameters.stack.push("6");
    ...
    @Test
    public void multi() throws StackExceptions, WorkerExeption {
        StackParameters stackParameters = new StackParameters();
        stackParameters.stack.push("5");
        stackParameters.stack.push("6");
    ...
    @Test
    public void div() throws StackExceptions, WorkerExeption {
        StackParameters stackParameters = new StackParameters();
        stackParameters.stack.push("10");
    ...
    @Test
    public void sqrt() throws StackExceptions, WorkerExeption {
        StackParameters stackParameters = new StackParameters();
